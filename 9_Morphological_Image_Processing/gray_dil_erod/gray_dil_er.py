...
A = plt.imread("imagen10.jpg") # lectura de imagen en escala a grises
...
plt.imshow(DA, cmap='gray', vmin = 0, vmax = 255, interpolation='none')

plt.subplot(133) # posicionamiento de la nueva imagen
plt.title("Imagen Erosionada") 
plt.imshow(EA, cmap='gray', vmin = 0, vmax = 255, interpolation='none')
